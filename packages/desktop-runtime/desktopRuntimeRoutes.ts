...
// 其中 desktopAgentRuntimeStatusHandler / desktopAgentRuntimeTurnHandler 会传递
...
export const desktopRuntimeRoutes: Record<string, any> = createApiRouteFamily([
  ...
  { path: "/api/desktop/provider-runtime", handlers: { GET: d("handleDesktopLlamaRuntimeGet"), POST: d("handleDesktopLlamaRuntimePost") } },
  { path: "/api/desktop/agent-runtime/status", handlers: { GET: d("handleDesktopAgentRuntimeStatusGet") } },
