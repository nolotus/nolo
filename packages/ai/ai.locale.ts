      ...
      tools: {
        createAgent: {
          ...
          params: {
            ...
            model: "The model name to use. Logic: Default 'nolo/glm-5.2'. Complex tasks: 'openai/gpt-5.2'. Cost-saving: 'openai/gpt-5.1'. Aesthetic/Creative: 'gemini-3.8-flash'. Reliable low-cost summary/reasoning: 'deepseek-v4-pro'. Image Generation: 'gemini-3-pro-image-preview' (Best/Expensive), 'gemini-3.1-flash-image-preview' (Ordinary), or 'gemini-3.1-flash-lite-image' (Fastest/Cheapest).",
      ...
      tools: {
        createAgent: {
          ...
          params: {
            ...
            model: "默认使用 'nolo/glm-5.2'。复杂任务: 'openai/gpt-5.2'。省成本但复杂: 'openai/gpt-5.1'。追求美观/创意: 'gemini-3.8-flash'。低成本摘要/推理: 'deepseek-v4-pro'。生成图片: 贵/高质量选 'gemini-3-pro-image-preview'，普通选 'gemini-3.1-flash-image-preview'，最快最便宜选 'gemini-3.1-flash-lite-image'。",
