...
export const toolsTabStyles = stylex.create({
  ...
  section: {
    ...
    backgroundColor: agentThemeTokens.surfaceOverlaySoft,
    borderWidth: "1px",
    borderStyle: "solid",
  ...
  collapsedNote: {
    ...
    color: "var(--textSecondary)",
    backgroundColor: agentThemeTokens.surfaceOverlayNote,
    fontSize: "13px",
    lineHeight: 1.6,
  },
  skillsGrid: {
  ...
  skillCard: {
    ...
    borderColor: agentThemeTokens.borderOverlaySoft,
    borderRadius: "var(--radius-sm)",
    backgroundColor: agentThemeTokens.surfaceOverlaySkill,
    color: "inherit",
    textAlign: "left",
    transition:
  ...
  chip: {
    ...
    padding: "3px 10px",
    borderRadius: "999px",
    backgroundColor: agentThemeTokens.surfaceOverlayStrong,
    borderWidth: "1px",
    borderStyle: "solid",
  ...
  emptyState: {
    ...
    padding: "16px",
    borderRadius: "var(--radius-sm)",
    backgroundColor: agentThemeTokens.surfaceOverlayFaint,
    borderWidth: "1.5px",
    borderStyle: "dashed",
  ...
  dialogError: {
    padding: "10px 12px",
    borderRadius: "var(--radius-xs)",
    backgroundColor: "color-mix(in srgb, var(--error, #ef4444) 8%, transparent)",
    borderWidth: "1px",
    borderStyle: "solid",
    borderColor: "color-mix(in srgb, var(--error, #ef4444) 20%, transparent)",
    color: "var(--error, #ef4444)",
    fontSize: "13px",
    lineHeight: 1.5,
  },
