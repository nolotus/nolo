...
const basicInfoSource = readFileSync(join(import.meta.dir, "BasicInfoTab.tsx"), "utf8");
...
describe("AgentForm source contract", () => {
  ...
  it("accepts machine preselection through create-agent query params", () => {
    ...
    expect(source).toContain('setValue("apiSource", "cli")');
    expect(source).toContain('setValue("machineId", machineId)');
  });
