...
export const referencesTabStyles = stylex.create({
  ...
  card: {
    ...
    minHeight: 0,
    padding: "var(--space-4)",
    backgroundColor: agentThemeTokens.surfaceOverlayHairline,
    borderWidth: "1px",
    borderStyle: "solid",
  ...
  cardCount: {
    ...
    padding: "0 8px",
    borderRadius: "999px",
    backgroundColor: agentThemeTokens.surfaceBadgeSubtle,
  ...
  dialogError: {
    borderRadius: "var(--radius-md)",
    backgroundColor: "var(--dangerBackground, rgba(239, 68, 68, 0.08))",
  ...
  item: {
    ...
    backgroundColor: agentThemeTokens.surfaceCardItem,
  ...
  empty: {
    ...
    minHeight: "72px",
    borderRadius: "var(--radius-sm)",
    backgroundColor: agentThemeTokens.surfaceCardEmpty,
    ...
    borderWidth: "1px",
    borderStyle: "dashed",
    borderColor: "var(--borderLight, rgba(0, 0, 0, 0.08))",
  },
  emptyTitle: {
    color: "var(--textSecondary)",
    fontSize: "var(--fontSize-sm)",
