    ...
    if (priceHint && !isCliAgent) {
      if (priceHint.type === "per_image") {
        rows.push({
          icon: <LuImage size={14} aria-hidden="true" />,
          key: "price",
          label: priceHint.labelKey
            ? t(priceHint.labelKey, "默认档参考价")
            : t("price"),
          value: `${formatPriceAmount(priceHint.amount)} / ${t("perImage")}${
        ...
        rows.push({
          ...
          key: "price",
          label: t("modelCost", "模型成本"),
          value: formatAgentOutputPrice(item.outputPrice),
        });
      }
    }
            ...
            <div className="agent-page__header-top">
              ...
              <div className="agent-page__info">
                ...
                <div className="agent-page__meta">
                  ...
                  {details.map((d) => (
                    <div key={d.key} className="agent-page__meta-item">
                      {d.icon}
