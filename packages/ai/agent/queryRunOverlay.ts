...
//
// NOTE: the turn-end overlay broadcast was removed (feat/web-overlay-remove);
// this module now has no production caller and is kept as the on-demand query
// capability for agents (plus test coverage). Do not delete it as dead code.
//
