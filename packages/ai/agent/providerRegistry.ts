...
export const SUBSCRIPTION_OAUTH_PROVIDERS: OAuthProviderConfig[] = [
  {
    ...
    modelOptions: [
      { id: "gpt-6-astra", label: "GPT-6 Astra", hasVision: true, recommended: true },
      { id: "gpt-5.6-sol", label: "GPT-5.6 Sol", hasVision: true },
...
export const CUSTOM_API_KEY_TEMPLATES: ApiKeyTemplateConfig[] = [
  ...
  },
  {
    ...
    keyFormatHint: "在 platform.stepfun.com Step Plan 控制台创建专用 API Key（形如 sk-…）；与开放平台按量 Key 独立。",
    commercialKind: "subscription",
    accessVariant: "token_plan_endpoint",
  },
  {
  ...
  },
  {
    ...
    description: "智谱国际版订阅（z.ai 控制台 API Key，Lite/Pro/Max 档）",
    provider: "zai",
    baseUrl: "https://api.z.ai/api/coding/paas/v4",
    defaultModel: "glm-5.3-flash",
    modelOptions: [
      { id: "glm-5.3-flash", label: "GLM 5.3 Flash", hasVision: true, recommended: true },
  ...
  },
  {
    ...
    label: "智谱 BigModel Coding Plan",
    description: "智谱国内版订阅（bigmodel.cn 控制台 API Key，与国际版 Key 不通用）",
    provider: "bigmodel",
    baseUrl: "https://open.bigmodel.cn/api/coding/paas/v4",
    defaultModel: "glm-5.3",
    modelOptions: [
      { id: "glm-5.3", label: "GLM 5.3", hasVision: true, recommended: true },
      { id: "glm-5.3-flash", label: "GLM 5.3 Flash", hasVision: true },
      { id: "glm-5-turbo", label: "GLM 5 Turbo" },
      { id: "glm-4.7", label: "GLM 4.7" },
    ],
    commercialKind: "subscription",
