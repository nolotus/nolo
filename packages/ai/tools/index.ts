...
import {
  ...
  updateAgentAutomationFunc,
  updateAgentAutomationFunctionSchema,
  deleteAgentAutomationFunc,
  deleteAgentAutomationFunctionSchema,
  notifyUserFunc,
...
export async function toolQueryFunc(args: any): Promise<{
  ...
  const query = toTrimmedString(task);
...
const baseToolDefinitions: ToolDefinition[] = [
  ...
  {
    id: "updateAgentAutomation",
    schema: updateAgentAutomationFunctionSchema,
    executor: updateAgentAutomationFunc,
    description: {
      name: "updateAgentAutomation",
      description:
        "更新一个 agent automation 的标题、instruction、trigger、status 等字段。",
      category: "计划与编排",
    },
    behavior: "action",
    uiGroup: "general",
  ...
  {
    id: "deleteAgentAutomation",
    schema: deleteAgentAutomationFunctionSchema,
    executor: deleteAgentAutomationFunc,
    description: {
      name: "deleteAgentAutomation",
      description: "删除一个 agent automation 及其 owner index。",
      category: "计划与编排",
    },
    behavior: "action",
    uiGroup: "general",
