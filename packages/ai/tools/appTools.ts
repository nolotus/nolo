...
export const appFileListFunctionSchema = {
  name: "appFileList",
  description:
    "列出 Nolo React SSR 应用源码工作区的文件清单。它是 App Builder 受限版文件列表：只绑定当前 app 源码 workspace，不会返回完整源码。",
  parameters: {
    type: "object",
    properties: {
      appId: {
...
export const appFileSearchFunctionSchema = {
  name: "appFileSearch",
  description:
    "在 Nolo React SSR 应用源码工作区搜索关键词或正则。它是 App Builder 受限版代码搜索；先定位命中行，再用 appFileRead 读取范围或 appFileReplace 精确编辑。",
  parameters: {
    type: "object",
    properties: {
      appId: {
