 ...
 *
 * 说明：
 * - 国内服务，人民币计价，不乘美元汇率系数；改用 toCnyCredits 统一加价
 *   （见 ai/llm/platformHosted 的 CNY_UPSTREAM_MULTIPLIER），否则毛利为 0。
 *   下方 price 里的数字为官方人民币原价。
...
export const qwenModels: Model[] = [
  // ── Qwen3 旗舰 ──
  {
    ...
    price: { input: toCnyCredits(12), output: toCnyCredits(36) },
    provider: "qwen",
  ...
  },
  {
    ...
    supportsTool: true,
    supportsReasoningEffort: true,
    price: { input: toCnyCredits(6), output: toCnyCredits(24) },
    provider: "qwen",
  ...
  },
  {
    ...
    supportsTool: true,
    supportsReasoningEffort: true,
    price: { input: toCnyCredits(4), output: toCnyCredits(12) },
    provider: "qwen",
  },
  {
    ...
    supportsTool: true,
    supportsReasoningEffort: true,
    price: { input: toCnyCredits(2), output: toCnyCredits(6) },
    provider: "qwen",
  },
  ...
  // ── Qwen3-Coder 编程系列 ──
  {
    ...
    supportsTool: true,
    supportsReasoningEffort: true,
    price: { input: toCnyCredits(3), output: toCnyCredits(9) },
    provider: "qwen",
  ...
  },
  {
    ...
    supportsTool: true,
    supportsReasoningEffort: true,
    price: { input: toCnyCredits(1), output: toCnyCredits(3) },
    provider: "qwen",
  },
  {
    ...
    supportsTool: true,
    supportsReasoningEffort: true,
    price: { input: toCnyCredits(5), output: toCnyCredits(15) },
    provider: "qwen",
  },
  ...
  // ── 长上下文 ──
  {
    ...
    fnCall: false,
    supportsTool: false,
    price: { input: toCnyCredits(0.5), output: toCnyCredits(2) },
    provider: "qwen",
  ...
  // ── 旧版主力（仍常用） ──
  {
    ...
    supportsTool: true,
    supportsReasoningEffort: true,
    price: { input: toCnyCredits(0.8), output: toCnyCredits(2) },
    provider: "qwen",
  },
  {
    name: "qwen-turbo",
    ...
    fnCall: true,
    supportsTool: true,
    price: { input: toCnyCredits(0.3), output: toCnyCredits(0.6) },
    provider: "qwen",
  },
  {
    name: "qwen-flash",
    ...
    fnCall: true,
    supportsTool: true,
    price: { input: toCnyCredits(0.1), output: toCnyCredits(0.3) },
    provider: "qwen",
  },
  ...
  // ── 推理（QwQ） ──
  {
    ...
    supportsTool: true,
    supportsReasoningEffort: true,
    price: { input: toCnyCredits(2), output: toCnyCredits(8) },
    provider: "qwen",
