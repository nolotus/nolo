...
export default function MatchPage() {
  ...
  const [matched, setMatched] = useState<DemoUser | null>(null);

  const MATCH_TARGET = 2;

  // ---------- 操作 ----------
  const goNext = (action: string) => {
  ...
  return (
    <div style={styles.page}>
      ...
      <nav style={styles.nav}>
        ...
        <button type="button" style={styles.tab} onClick={() => navigate("/chat/1")}>
          {t("chat")}
        </button>
        <button type="button" style={styles.tab} onClick={() => navigate("/profile")}>
          {t("my")}
        </button>
        ...
        {matched ? (
          <div style={styles.modalOverlay}>
            <div style={styles.modal}>
              ...
              <button type="button" style={styles.chatBtn} onClick={startChat}>
                {t("start_chat")}
              </button>
            </div>
          </div>
