...
export default function MyProfile() {
  ...
  return (
    <div style={style.page}>
      {/* 顶部导航栏 */}
      <nav style={style.nav}>
        <button type="button" style={style.tab} onClick={() => navigate("/match")}>
          {t("match")}
        </button>
        <button type="button" style={style.tab} onClick={() => navigate("/chat/1")}>
          {t("chat")}
        </button>
        <button type="button" style={{ ...style.tab, ...style.activeTab }}>{t("my")}</button>
        <button type="button" style={style.langBtn} onClick={toggleLanguage}>
      ...
      <div style={style.profileBox}>
        ...
        <div style={style.actions}>
          <button type="button" style={style.editBtn} onClick={handleEdit}>
            {t("edit_profile")}
          </button>
          <button type="button" style={style.logoutBtn} onClick={handleLogout}>
            {t("logout")}
          </button>
        </div>
      </div>
