...
} from "/public/assets/chunks/chunk-7YRMQMID.js";
import {
  populateCommonDb
} from "/public/assets/chunks/chunk-MG4KWFQ6.js";
import {
  ImperativeState
} from "/public/assets/chunks/chunk-BJFHR2KX.js";
import {
  selectSvgElement
...
function getAlignments(db2, spatialMaps, groupAlignments) {
  ...
  const alignments = spatialMaps.map((spatialMap) => {
    ...
    Object.entries(spatialMap).forEach(([id, [x, y]]) => {
      ...
      (_a = horizontalAlignments[y])[nodeGroup] ?? (_a[nodeGroup] = []);
