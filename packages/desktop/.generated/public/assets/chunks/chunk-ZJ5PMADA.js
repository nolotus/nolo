...
${r}`;return{rawData:t,displayData:i}};async function T(n,r){let t=n.id??n.doc??n.docKey??n.pageKey??n.key;if(!t||!t.toLowerCase().startsWith("page-"))throw new Error(`\u65E0\u6548\u7684\u9875\u9762 ID: ${t}\u3002\u9875\u9762 ID \u901A\u5E38\u4EE5 "page-" \u5F00\u5934\u3002`);try{let{readAction:i}=await import("/public/assets/chunks/read-BCG6HQAL.js"),l=await i({dbKey:t},r);if(!l)throw new Error(`\u672A\u627E\u5230 ID \u4E3A ${t} \u7684\u9875\u9762\u3002`);return S(l)}catch(i){throw new Error(`\u8BFB\u53D6\u9875\u9762\u65F6\u51FA\u9519: ${f(i)}`)}}var O=T;export{k as a,M as b,K as c,S as d,T as e,O as f};
