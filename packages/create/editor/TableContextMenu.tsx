...
export const TableContextMenu: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const shouldShow = !!(
      selection && ReactEditor.isFocused(editor as ReactEditor) && isSelectionInTable(editor as ReactEditor)
    );
    ...
    if (shouldShow) {
      ...
      if (table) {
        ...
        const tableDomNode = ReactEditor.toDOMNode(editor as ReactEditor, table[0]);
  ...
  const menu = show ? (
    ...
    >
      ...
      <div style={buttonGroupStyle}>
        <Button onClick={() => insertRow(editor as ReactEditor, "above")}>
          <LuArrowUpFromLine
            size={16}
        ...
        <Button onClick={() => insertRow(editor as ReactEditor, "below")}>
          <LuArrowDownFromLine
            size={16}
            style={{ marginRight: "var(--space-2)" }}
            aria-hidden="true"
      ...
      <div style={buttonGroupStyle}>
        <Button onClick={() => insertColumn(editor as ReactEditor, "left")}>
          <LuArrowLeftFromLine
            size={16}
            style={{ marginRight: "var(--space-2)" }}
            aria-hidden="true"
        ...
        <Button onClick={() => insertColumn(editor as ReactEditor, "right")}>
          <LuArrowRightFromLine
            size={16}
            style={{ marginRight: "var(--space-2)" }}
            aria-hidden="true"
      ...
      />
      <div style={buttonGroupStyle}>
        <Button onClick={() => deleteRow(editor as ReactEditor)}>
          <LuRows3
            size={16}
            style={{ marginRight: "var(--space-2)" }}
            aria-hidden="true"
        ...
        <Button onClick={() => deleteColumn(editor as ReactEditor)}>
          <LuColumns3
            size={16}
            style={{ marginRight: "var(--space-2)" }}
            aria-hidden="true"
        ...
        <Button onClick={() => deleteTable(editor as ReactEditor)}>
          <LuTrash2
            size={16}
            style={{ marginRight: "var(--space-2)" }}
            aria-hidden="true"
