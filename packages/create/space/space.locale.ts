...
export default {
  [Language.EN]: {
    translation: {
      ...
      deleteMovedToTrashBatch: "{{count}} items moved to Recycle Bin",
      batchDeleteCancelled: "Batch delete cancelled",
      uploadSuccess: "Upload complete",
      uploadFailed: "Upload failed",
      uploadPartial: "{{succeeded}} uploaded, {{failed}} failed",
      retry: "Retry",
  ...
  [Language.ZH_CN]: {
    translation: {
      ...
      bound_folder: "绑定文件夹",
      bound_folder_hint: "绑定本地文件夹作为空间来源",
      choose_folder: "选择文件夹",
      change_folder: "更换",
      folder_as_name: "已用文件夹名作为空间名",
      // === 空间选择 ===
      default_space: "默认空间",
      select_space: "选择空间",
      no_spaces: "暂无空间",
      no_spaces_yet: "尚未创建任何空间",
      space_list_failed: "空间列表加载失败，点击重试",
      space_list: "空间列表",
      space_dropdown: "打开空间菜单",
      current_space: "当前空间",
      switch_space: "切换空间",
      offline_local_cache: "离线 · 本地缓存",
      ...
      deleteMovedToTrashBatch: "{{count}} 项内容已移至回收站",
      batchDeleteCancelled: "批量删除已取消",
      uploadSuccess: "上传完成",
      uploadFailed: "上传失败",
      uploadPartial: "{{succeeded}} 个成功，{{failed}} 个失败",
      retry: "重试",
      uploadFile: "上传文件",
      uploading: "上传中...",
  ...
  [Language.ZH_HANT]: {
    translation: {
      ...
      bound_folder: "綁定資料夾",
      bound_folder_hint: "綁定本地資料夾作為空間來源",
      choose_folder: "選擇資料夾",
      change_folder: "更換",
      folder_as_name: "已用資料夾名稱作為空間名稱",
      default_space: "預設空間",
      select_space: "選擇空間",
      no_spaces: "暫無空間",
      no_spaces_yet: "尚未創建任何空間",
      space_list_failed: "空間清單載入失敗，點擊重試",
      space_list: "空間清單",
      space_dropdown: "開啟空間選單",
      current_space: "目前空間",
      switch_space: "切換空間",
      offline_local_cache: "離線 · 本機快取",
      ...
      deleteMovedToTrashBatch: "{{count}} 項內容已移至回收站",
      batchDeleteCancelled: "批量刪除已取消",
      uploadSuccess: "上傳完成",
      uploadFailed: "上傳失敗",
      uploadPartial: "{{succeeded}} 個成功，{{failed}} 個失敗",
      retry: "重試",
      uploadFile: "上傳檔案",
      uploading: "上傳中...",
  ...
  [Language.JA]: {
    translation: {
      ...
      creating: "スペースを作成中...",
      pick_folder_failed: "フォルダの選択に失敗しました",
      bound_folder: "バインドフォルダ",
      bound_folder_hint: "ローカルフォルダをスペースのソースとしてリンク",
      choose_folder: "フォルダを選択",
      change_folder: "変更",
      folder_as_name: "フォルダ名をスペース名として使用",
      ...
      offline_local_cache: "オフライン · ローカルキャッシュ",
      ...
      deleteMovedToTrashBatch: "{{count}} 件のアイテムをゴミ箱に移動しました",
      batchDeleteCancelled: "一括削除がキャンセルされました",
      uploadSuccess: "アップロード完了",
      uploadFailed: "アップロード失敗",
      uploadPartial: "{{succeeded}} 件成功、{{failed}} 件失敗",
      retry: "再試行",
