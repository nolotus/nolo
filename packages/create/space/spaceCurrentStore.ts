...
// Re-export from spaceCurrentSelectors for backward compat with consumers
// that still import from spaceCurrentStore. New code should import directly
// from spaceCurrentSelectors.
export { useCurrentSpaceFromEntity } from "./spaceCurrentSelectors";