 ...
 *
 * This test feeds the exact event pattern (text → globFiles → many
    ...
    const tool = (name: string, args: string, ok = true) => {
      ...
      turn.handleToolEvent({
        ...
        metadata: {
          ...
          query: name === "codeSearch" ? args : undefined,
