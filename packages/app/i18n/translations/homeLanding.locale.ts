...
export default {
  [Language.EN]: {
    translation: {
      ...
      homeLandingFaq: {
        kicker: "FAQ",
        title: "Before you hand Nolo a real task",
        description: "The practical questions that matter once you want AI to do more than answer a prompt.",
      },
    },
  },
  [Language.ZH_CN]: {
    translation: {
      ...
      homeLandingFaq: {
        kicker: "常见问题",
        title: "把真实任务交给 Nolo 之前，你可能会关心这些",
        description: "不是 Agent 黑话，而是当 AI 真正开始替你做事之后会遇到的问题。",
      },
    },
  },
  [Language.ZH_HANT]: {
    translation: {
      ...
      homeLandingFaq: {
        kicker: "常見問題",
        title: "把真實任務交給 Nolo 之前，你可能會關心這些",
        description: "不是 Agent 黑話，而是當 AI 真正開始替你做事之後會遇到的問題。",
      },
    },
  },
  [Language.JA]: {
    translation: {
      ...
      homeLandingFaq: {
        kicker: "FAQ",
        title: "実際の仕事を Nolo に任せる前に知っておきたいこと",
        description: "Agent の専門用語ではなく、AI が本当に作業を進め始めたときに気になる実務上の質問です。",
      },
    },
  },
};
