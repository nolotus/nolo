...
describe("resolveAgentCallPlan — legacy deepseek-provider records", () => {
  // Legacy provider records are normalized to the platform-hosted Responses route.
  test("V4 Flash uses the hosted Responses wire", () => {
    const plan = resolveAgentCallPlan(
  ...
  test("V4 Pro routes to the same hosted Responses upstream", () => {
    const plan = resolveAgentCallPlan(
