...
const Heading = ({ level, children, style }: { level: number; children?: ReactNode; style?: any }) => {
	let headingStyle;
	switch (level) {
		case 1:
...
const Link = ({ href, children, style }: { href?: string; children?: ReactNode; style?: any }) => (
...
const Paragraph = ({ children, style }: { children?: ReactNode; style?: any }) => (
	<Text style={[styles.paragraph, style]}>{children}</Text>
);

const Strong = ({ children, style }: { children?: ReactNode; style?: any }) => (
