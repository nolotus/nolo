...
export const queueBadgeStyles = stylex.create({
  ...
  pill: {
    ...
    borderRadius: "999px",
    border: "1px solid var(--nolo-border, rgba(120, 120, 120, 0.35))",
    background: "var(--nolo-surface-2, rgba(120, 120, 120, 0.12))",
  ...
  popover: {
    ...
    maxWidth: "320px",
    borderRadius: "8px",
    border: "1px solid var(--nolo-border, rgba(120, 120, 120, 0.3))",
    background: "var(--nolo-surface, #fff)",
  ...
  popoverHeader: {
    ...
    fontSize: "0.8rem",
    fontWeight: 600,
    borderBottom: "1px solid var(--nolo-border, rgba(120, 120, 120, 0.2))",
  },
  clear: {
    border: "none",
    background: "none",
  ...
  item: {
    ...
    borderBottom: "1px solid var(--nolo-border-faint, rgba(120, 120, 120, 0.1))",
    whiteSpace: "nowrap",
    overflow: "hidden",
