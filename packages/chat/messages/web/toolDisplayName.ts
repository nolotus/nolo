 ...
 * or returns the raw API name / key path — never show globFiles/execShell bare.
 */
 ...
 * Always prefers a real human label over raw API names like `globFiles`.
 */
 ...
 * over opaque tool API names ("globFiles × 8"). Falls back to
