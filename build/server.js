...
/*! unknown exports (runtime-defined) */
/*! runtime requirements: __webpack_exports__, top-level-this-exports, __webpack_require__ */
/*! CommonJS bailout: this is used directly at 1:492-496 */
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {

eval("var _interopRequireDefault=__webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ \"@babel/runtime/helpers/interopRequireDefault\");var _interopRequireWildcard=__webpack_require__(/*! @babel/runtime/helpers/interopRequireWildcard */ \"@babel/runtime/helpers/interopRequireWildcard\");Object.defineProperty(exports, \"__esModule\", ({value:true}));exports.default=void 0;var _slicedToArray2=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ \"@babel/runtime/helpers/slicedToArray\"));var _react=_interopRequireWildcard(__webpack_require__(/*! react */ \"react\"));var _reactDom=_interopRequireWildcard(__webpack_require__(/*! react-dom */ \"react-dom\"));var _log=__webpack_require__(/*! ./log */ \"./components/Editor/myeditor/log.js\");var _this=this,_jsxFileName=\"C:\\\\Users\\\\nolot\\\\nolo-ssr\\\\components\\\\Editor\\\\myeditor\\\\index.js\";var Editor=function Editor(props){var onChange=props.onChange;var editorEl=(0,_react.useRef)(null);var _useState=(0,_react.useState)(''),_useState2=(0,_slicedToArray2[\"default\"])(_useState,2),state=_useState2[0],setstate=_useState2[1];var onBeforeInput=function onBeforeInput(e){e.preventDefault();};var compositionUpdate=function compositionUpdate(e){e.preventDefault();if(_log.logOption.compositionUpdate){console.log('compositionUpdate',e);}};var compositionStart=function compositionStart(e){e.preventDefault();if(_log.logOption.compositionStart){console.log('compositionStart',e);}};var compositionEnd=function compositionEnd(e){e.preventDefault();if(_log.logOption.compositionEnd){console.log('compositionEnd',e);}reallyChange(e.data);};var reallyChange=function reallyChange(e){console.log('reallyChange',e);(0,_reactDom.unstable_batchedUpdates)(function(){setstate(\"<div style=\\\"display: inline;background:yellow;>\"+Math.random()+\"\\n\"+Math.random()+\"</div>\");});};var onBlur=function onBlur(e){};return _react[\"default\"].createElement(_react[\"default\"].Fragment,null,_react[\"default\"].createElement(\"div\",{contentEditable:true,onBlur:onBlur,onBeforeInput:onBeforeInput,ref:editorEl,onCompositionUpdate:compositionUpdate,onCompositionStart:compositionStart,onCompositionEnd:compositionEnd,dangerouslySetInnerHTML:{__html:state},__self:_this,__source:{fileName:_jsxFileName,lineNumber:60,columnNumber:7}}),_react[\"default\"].createElement(\"button\",{onClick:function onClick(){setstate(Math.random()+\"\\n\"+Math.random());},__self:_this,__source:{fileName:_jsxFileName,lineNumber:72,columnNumber:7}},\"Click me to change contnet\"));};var _default=Editor;exports.default=_default;\n\n//# sourceURL=webpack://nolo/./components/Editor/myeditor/index.js?");
