...
eval("var _interopRequireDefault=__webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ \"@babel/runtime/helpers/interopRequireDefault\");Object.defineProperty(exports, \"__esModule\", ({value:true}));exports.default=void 0;var _defineProperty2=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ \"@babel/runtime/helpers/defineProperty\"));var _menu=__webpack_require__(/*! ../config/menu */ \"./config/menu.js\");var _db=__webpack_require__(/*! ./db */ \"./common/db.js\");function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2.default)(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var initState={templateName:'simple',userInfo:null,navs:_menu.defaultNavConfig,setting:{},authData:{isLogin:false},userDb:null,modalInfo:{isVisible:false}};var reducer=function reducer(){var state=arguments.length>0&&arguments[0]!==undefined?arguments[0]:initState;var action=arguments.length>1?arguments[1]:undefined;var payload=action.payload;switch(action.type){case'fetch':return _objectSpread(_objectSpread({},state),{},{users:action.payload});case'modal':return _objectSpread(_objectSpread({},state),{},{modalInfo:_objectSpread({isVisible:true},payload.modalInfo)});case'closeModal':return _objectSpread(_objectSpread({},state),{},{modalInfo:{isVisible:false}});case'loginSuccess':return _objectSpread(_objectSpread({},state),{},{authData:{isLogin:true},userInfo:action.payload.userInfo,userDb:action.payload.userDb});case'logout':return _objectSpread(_objectSpread({},state),{},{authData:{isLogin:false},userInfo:{}});case'initSuccess':return _objectSpread(_objectSpread({},state),{},{nav:action.payload.nav,setting:action.payload.setting});default:return state;}};var _default=reducer;exports.default=_default;\n\n//# sourceURL=webpack://nolo/./common/reducer.js?");
