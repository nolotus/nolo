...
eval("var _interopRequireDefault=__webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ \"@babel/runtime/helpers/interopRequireDefault\");var _interopRequireWildcard=__webpack_require__(/*! @babel/runtime/helpers/interopRequireWildcard */ \"@babel/runtime/helpers/interopRequireWildcard\");Object.defineProperty(exports, \"__esModule\", ({value:true}));exports.Page=void 0;var _regenerator=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ \"@babel/runtime/regenerator\"));var _asyncToGenerator2=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"@babel/runtime/helpers/asyncToGenerator\"));var _slicedToArray2=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ \"@babel/runtime/helpers/slicedToArray\"));var _react=_interopRequireWildcard(__webpack_require__(/*! react */ \"react\"));var _api=__webpack_require__(/*! ../common/api */ \"./common/api.js\");var _reactRouterDom=__webpack_require__(/*! react-router-dom */ \"react-router-dom\");var _Article=__webpack_require__(/*! ../components/Article */ \"./components/Article/index.js\");var _template=_interopRequireDefault(__webpack_require__(/*! ../template */ \"./template/index.js\"));var _Loading=__webpack_require__(/*! ../components/Loading */ \"./components/Loading/index.js\");var _db=__webpack_require__(/*! ../common/db */ \"./common/db.js\");var _this=this,_jsxFileName=\"D:\\\\nolo\\\\pages\\\\Page.js\";var Page=function Page(props){function useQuery(){return new URLSearchParams((0,_reactRouterDom.useLocation)().search);}var query=useQuery();var rev=query.get('rev');var id=(0,_reactRouterDom.useParams)().id||props.id;var _useState=(0,_react.useState)(),_useState2=(0,_slicedToArray2[\"default\"])(_useState,2),doc=_useState2[0],setDoc=_useState2[1];(0,_react.useEffect)(function(){var getdata=function(){var _ref=(0,_asyncToGenerator2[\"default\"])(_regenerator[\"default\"].mark(function _callee(){var hostDoc,localDoc;return _regenerator[\"default\"].wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return(0,_api.dbGet)(_db.hostDb.remote,id);case 2:hostDoc=_context.sent;console.log('hostDoc',hostDoc);console.log('hostDb',_db.hostDb);console.log('localDb',_db.localDb);_context.next=8;return(0,_api.dbGet)(_db.localDb,id);case 8:localDoc=_context.sent;console.log('localDoc',localDoc);if(!hostDoc){_context.next=13;break;}hostDoc!==undefined&&setDoc(hostDoc);return _context.abrupt(\"return\");case 13:localDoc!==undefined&&setDoc(localDoc);case 14:case\"end\":return _context.stop();}}},_callee);}));return function getdata(){return _ref.apply(this,arguments);};}();getdata();return function(){};},[id]);return _react[\"default\"].createElement(_template[\"default\"],{__self:_this,__source:{fileName:_jsxFileName,lineNumber:37,columnNumber:10}},doc?_react[\"default\"].createElement(_Article.Article,{doc:doc,__self:_this,__source:{fileName:_jsxFileName,lineNumber:37,columnNumber:27}}):_react[\"default\"].createElement(_Loading.LoadingBox,{__self:_this,__source:{fileName:_jsxFileName,lineNumber:37,columnNumber:51}}));};exports.Page=Page;\n\n//# sourceURL=webpack://nolo/./pages/Page.js?");
