...
eval("var _interopRequireDefault=__webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ \"@babel/runtime/helpers/interopRequireDefault\");var _interopRequireWildcard=__webpack_require__(/*! @babel/runtime/helpers/interopRequireWildcard */ \"@babel/runtime/helpers/interopRequireWildcard\");Object.defineProperty(exports, \"__esModule\", ({value:true}));exports.default=void 0;var _extends2=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/extends */ \"@babel/runtime/helpers/extends\"));var _slicedToArray2=_interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ \"@babel/runtime/helpers/slicedToArray\"));var _react=_interopRequireWildcard(__webpack_require__(/*! react */ \"react\"));var _slate=__webpack_require__(/*! slate */ \"slate\");var _slateHistory=__webpack_require__(/*! slate-history */ \"slate-history\");var _index=__webpack_require__(/*! ../slate-react/index.es */ \"./components/Editor/slate-react/index.es.js\");var _constant=__webpack_require__(/*! ./constant */ \"./components/Editor/neweditor/constant.js\");var _Element=_interopRequireDefault(__webpack_require__(/*! ./Element */ \"./components/Editor/neweditor/Element.js\"));var _shortcuts=_interopRequireDefault(__webpack_require__(/*! ./shortcuts */ \"./components/Editor/neweditor/shortcuts.js\"));var _deserialize=__webpack_require__(/*! ./deserialize */ \"./components/Editor/neweditor/deserialize.js\");var _this=this,_jsxFileName=\"D:\\\\nolo\\\\components\\\\Editor\\\\neweditor\\\\index.js\";var withShortcuts=function withShortcuts(editor){var deleteBackward=editor.deleteBackward,insertText=editor.insertText;editor.insertText=function(text){var selection=editor.selection;if(text===' '&&selection&&_slate.Range.isCollapsed(selection)){var anchor=selection.anchor;var block=_slate.Editor.above(editor,{match:function match(n){return _slate.Editor.isBlock(editor,n);}});var path=block?block[1]:[];var start=_slate.Editor.start(editor,path);var range={anchor:anchor,focus:start};var beforeText=_slate.Editor.string(editor,range);var type=_shortcuts[\"default\"][beforeText];if(type){_slate.Transforms.select(editor,range);_slate.Transforms[\"delete\"](editor);_slate.Transforms.setNodes(editor,{type:type},{match:function match(n){return _slate.Editor.isBlock(editor,n);}});if(type==='list-item'){var list={type:'bulleted-list',children:[]};_slate.Transforms.wrapNodes(editor,list,{match:function match(n){return n.type==='list-item';}});}return;}}insertText(text);};editor.deleteBackward=function(){var selection=editor.selection;if(selection&&_slate.Range.isCollapsed(selection)){var match=_slate.Editor.above(editor,{match:function match(n){return _slate.Editor.isBlock(editor,n);}});if(match){var _match=(0,_slicedToArray2[\"default\"])(match,2),block=_match[0],path=_match[1];var start=_slate.Editor.start(editor,path);if(block.type!=='paragraph'&&_slate.Point.equals(selection.anchor,start)){_slate.Transforms.setNodes(editor,{type:'paragraph'});if(block.type==='list-item'){_slate.Transforms.unwrapNodes(editor,{match:function match(n){return n.type==='bulleted-list';},split:true});}return;}}deleteBackward.apply(void 0,arguments);}};return editor;};var WrapEditor=function WrapEditor(props){var readOnly=props.readOnly;var onChange=function onChange(value){console.log('value',value);var headingOneArray=value.filter(function(item){return item.type==='heading-one';})||[];var title=headingOneArray[0]&&headingOneArray[0].children[0].text;var json={title:title,content:value};props.onChange(json);setValue(value);};var _useState=(0,_react.useState)(props.value||_constant.initialValue),_useState2=(0,_slicedToArray2[\"default\"])(_useState,2),value=_useState2[0],setValue=_useState2[1];var renderElement=(0,_react.useCallback)(function(props){return _react[\"default\"].createElement(_Element[\"default\"],(0,_extends2[\"default\"])({},props,{__self:_this,__source:{fileName:_jsxFileName,lineNumber:98,columnNumber:48}}));},[]);var renderLeaf=(0,_react.useCallback)(function(props){return _react[\"default\"].createElement(Leaf,(0,_extends2[\"default\"])({},props,{__self:_this,__source:{fileName:_jsxFileName,lineNumber:99,columnNumber:45}}));},[]);var editor=(0,_react.useMemo)(function(){return withHtml(withShortcuts((0,_index.withReact)((0,_slateHistory.withHistory)((0,_slate.createEditor)()))));},[]);return _react[\"default\"].createElement(_index.Slate,{editor:editor,value:value,onChange:onChange,__self:_this,__source:{fileName:_jsxFileName,lineNumber:105,columnNumber:5}},_react[\"default\"].createElement(_index.Editable,{readOnly:readOnly,renderElement:renderElement,renderLeaf:renderLeaf,spellCheck:true,autoFocus:true,__self:_this,__source:{fileName:_jsxFileName,lineNumber:106,columnNumber:7}}));};var withHtml=function withHtml(editor){var insertData=editor.insertData,isInline=editor.isInline,isVoid=editor.isVoid;editor.isInline=function(element){return element.type==='link'?true:isInline(element);};editor.isVoid=function(element){return element.type==='image'?true:isVoid(element);};editor.insertData=function(data){var html=data.getData('text/html');if(html){var parsed=new DOMParser().parseFromString(html,'text/html');var fragment=(0,_deserialize.deserialize)(parsed.body);_slate.Transforms.insertFragment(editor,fragment);return;}insertData(data);};return editor;};var Leaf=function Leaf(_ref){var attributes=_ref.attributes,children=_ref.children,leaf=_ref.leaf;if(leaf.bold){children=_react[\"default\"].createElement(\"strong\",{__self:_this,__source:{fileName:_jsxFileName,lineNumber:146,columnNumber:16}},children);}if(leaf.code){children=_react[\"default\"].createElement(\"code\",{__self:_this,__source:{fileName:_jsxFileName,lineNumber:150,columnNumber:16}},children);}if(leaf.italic){children=_react[\"default\"].createElement(\"em\",{__self:_this,__source:{fileName:_jsxFileName,lineNumber:154,columnNumber:16}},children);}if(leaf.underline){children=_react[\"default\"].createElement(\"u\",{__self:_this,__source:{fileName:_jsxFileName,lineNumber:158,columnNumber:16}},children);}if(leaf.strikethrough){children=_react[\"default\"].createElement(\"del\",{__self:_this,__source:{fileName:_jsxFileName,lineNumber:162,columnNumber:16}},children);}return _react[\"default\"].createElement(\"span\",(0,_extends2[\"default\"])({},attributes,{__self:_this,__source:{fileName:_jsxFileName,lineNumber:165,columnNumber:10}}),children);};var _default=WrapEditor;exports.default=_default;\n\n//# sourceURL=webpack://nolo/./components/Editor/neweditor/index.js?");

/***/ }),

/***/ "./components/Editor/neweditor/shortcuts.js":
/*!**************************************************!*\
  !*** ./components/Editor/neweditor/shortcuts.js ***!
  \**************************************************/
/***/ (() => {

eval("var SHORTCUTS={'*':'list-item','-':'list-item','+':'list-item','>':'block-quote','#':'heading-one','##':'heading-two','###':'heading-three','####':'heading-four','#####':'heading-five','######':'heading-six'};\n\n//# sourceURL=webpack://nolo/./components/Editor/neweditor/shortcuts.js?");
...
"use strict";
module.exports = require("@babel/runtime/helpers/taggedTemplateLiteralLoose");;
