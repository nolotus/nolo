...
describe("prepareNoloOpenSourceMirror public projection manifest & constants", () => {
  test("exports explicit public projection manifest and deny constants", () => {
    ...
    // billing 移出 HARD_DENY，作为公开 edition 包
    ...
    expect(excluded.has("packages/lab/date/pages/PaymentPromptPage.tsx")).toBe(true);
    ...
    // 3. Usage
    expect(excluded.has("packages/app/pages/widgets/UsageWidget.tsx")).toBe(true);
    expect(excluded.has("packages/app/pages/widgets/UsageWidget.css")).toBe(true);
    ...
    expect(excluded.has("packages/create/space/pages/SpaceInvite.tsx")).toBe(true);
    expect(excluded.has("packages/create/space/components/InviteModal.tsx")).toBe(true);
    expect(excluded.has("packages/create/space/pages/SpaceMembers.tsx")).toBe(true);
    ...
    expect(excluded.has("packages/lab/date/pages/LoginPage.tsx")).toBe(true);
    expect(excluded.has("packages/lab/date/guards/authGuard.tsx")).toBe(true);
  });
  ...
  test("copyTree applies exclusion manifest, omitting cloud-only paths while preserving Desktop/CLI/identity/database local", async () => {
    ...
    expect(existsSync(join(mockOutDir, "packages/app/pages/widgets/UsageWidget.tsx"))).toBe(false);
    ...
    expect(existsSync(join(mockOutDir, "packages/create/space/pages/SpaceInvite.tsx"))).toBe(false);
    expect(existsSync(join(mockOutDir, "packages/lab/date/pages/LoginPage.tsx"))).toBe(false);
