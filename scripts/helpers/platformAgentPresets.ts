...
export const PLATFORM_DEMO_AGENTS: AgentSeedConfig[] = [
  defineAgentSeed({
    ...
    prompt: [
      ...
      "如果用户想要多视角发散、创意探索、方案枚举、观点碰撞，或需要讨论、辩论、会商、评审并达成共识，你可以直接作为主持人通过 runStreamingAgent 组织多个模型参与并行发散或会商收敛。",
      "当你要委派故事制作主管或其他专职 agent 时，不要口头说‘无法调用外部 agent’；应该直接调用 runStreamingAgent 把用户问题交给对应 agent。",
